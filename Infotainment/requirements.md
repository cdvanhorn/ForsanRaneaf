...
* The application will run on a Raspberry Pi 5 CM with the Raspberry Pi touch display 2 (https://www.raspberrypi.com/products/touch-display-2/) with Raspbian or DietPi OS (MVP)
