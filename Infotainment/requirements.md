...
* The application will display warnings and errors
* The application will display vehicle status
* The application will play audio files from filesystem using cmus and cmus-remote (https://cmus.github.io/#home)
* The application will run on a Raspberry Pi 4 with the Raspberry Pi touchscreen
